...
{/*SECCION PRINCIPAL*/}
    <div style={{borderRadius:"50px",background:"linear-gradient(145deg, #24282d, #2b2f36)",boxShadow:"9px 9px 18px #101214,-9px -9px 18px #404650",width:"85%",minWidth:"150px",minHeight:200,display:"flex",flexDirection:"row",marginTop:"75px",justifyContent:"center",flexWrap:"wrap"}} id="Inicio">
...
{/*Proyectos*/}
    <div style={{borderRadius:"50px",background:"linear-gradient(145deg, #24282d, #2b2f36)",boxShadow:"9px 9px 18px #101214,-9px -9px 18px #404650",width:"85%",minWidth:"150px",minHeight:200,display:"flex",flexDirection:"row",marginTop:"45px",justifyContent:"center",flexWrap:"wrap"}} id="Inicio">
